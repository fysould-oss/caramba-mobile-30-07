...
<View style={styles.fichaTecnica}>
  ...
  <View style={styles.fichaLinha}>
    <Text style={styles.fichaLabel}>Segunda: Matemática 13:30-15:10</Text>
    <Text style={styles.fichaValor}>1.200h</Text>
  </View>

  <View style={styles.fichaLinha}>
    <Text style={styles.fichaLabel}>Terça: Português 13:30-15:10</Text>
    <Text style={styles.fichaValor}>800h</Text>
  </View>

  <View style={styles.fichaLinha}>
    <Text style={styles.fichaLabel}>Quarta: Inglês 13:30-15:10</Text>
    <Text style={styles.fichaValor}>400h</Text>
  </View>

  <View style={styles.fichaLinha}>
    <Text style={styles.fichaLabel}>Quinta: História 13:30-15:10</Text>
    <Text style={styles.fichaValor}>Vespertino</Text>
  </View>

  <View style={styles.fichaLinhaSemBorda}>
    <Text style={styles.fichaLabel}>Sexta: Geografia 13:30-15:10</Text>
